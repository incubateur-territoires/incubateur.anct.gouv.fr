        ...
        <div class="fr-col-12">
          ...
          <div class="fr-grid-row fr-grid-row--gutters fr-py-6w">
            <div class="fr-col">
              ...
              <Checkbox v-for="decoupages_administratifs in facets_groups.decoupages_administratifs" @change="filter('decoupages_administratifs', decoupages_administratifs.id, $event)" :label="decoupages_administratifs.nom" />
            </div>

            <div class="fr-col">
              <h4>Thématique</h4>
              <Checkbox v-for="thematique in facets_groups.thematiques" @change="filter('thematiques', thematique.id, $event)" :label="thematique.thematique" />
            </div>
          </div>
